...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CharacterNotBelongThisBookException.class)
    public ResponseEntity<String> handleCharacterNotBelongThisBookException(CharacterNotBelongThisBookException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }
