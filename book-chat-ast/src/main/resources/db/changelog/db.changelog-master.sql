...
--changeset AlexeySkripnichenko:12
INSERT INTO admins (id, name, role, surname, email, password_hash)
VALUES ('049e093f-bb16-483a-92bd-976a8bb80281', 'admin', 'ADMIN', 'ФИО', 'test@test.com',
        '$2a$10$jIABEKogS6UU.wiTr1hsA.JQkMdYhifQUeAhSuu4Nop2876HDtoB6')
ON CONFLICT (id) DO NOTHING;

--changeset AlexeySkripnichenko:13
INSERT INTO books (id, title, full_text, status, uploaded_path)
VALUES ('e3e44f89-68bc-47d9-bde2-8af76d94e29b', 'Герой нашего времени', 'Михаил Юрьевич Лермонтов
Герой нашего времени

Лермонтов, М.Ю. Герой нашего времени.- Санкт-Петербург: Азбука-классика,  2004.
...
Вера больна, очень больна, хотя в этом и не признается, я боюсь, чтобы не было у нее чахотки или той болезни, которую называют fievre lente  – болезнь не русская вовсе, и ей на нашем языке нет названия.
 Fievre lente  – медленная горячка .
...
77',
        'UPLOADED', 'src\main\resources\data\Лермонтов-М.-Ю.-Герой-нашего-времени.docx')
ON CONFLICT (id) DO NOTHING;
